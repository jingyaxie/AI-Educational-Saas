...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'username', 'group', 'group_id', 'role', 'valid_until', 'date_joined', 'token_usage', 'api_key', 'is_active', 'openai_api_key', 'deepseek_api_key']
...
class KnowledgeBaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KnowledgeBase
        fields = ['id', 'name', 'type', 'description', 'created', 'files_count', 'char_count', 'embedding_config']
